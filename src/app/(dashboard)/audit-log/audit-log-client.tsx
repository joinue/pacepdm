...
const actionLabels: Record<string, string> = {
  ...
  "leadtime.add": "Lead Time Added",
  "leadtime.update": "Lead Time Update",
  "leadtime.flag": "Lead Time Flagged",
  "leadtime.flag_cleared": "Lead Time Flag Cleared",
  "changelog.post": "Change Log Post",
  "changelog.edit": "Change Log Edit",
  "changelog.withdraw": "Change Log Withdrawn",
  "changelog.attach": "Change Log Attachment",
  "changelog.comment": "Change Log Reply",
  "changelog.comment_edit": "Change Log Reply Edit",
  "changelog.comment_withdraw": "Change Log Reply Withdrawn",
...
const entityTypeLabels: Record<string, string> = {
  ...
  lifecycle: "Lifecycle",
  equipment_lead_time: "Lead Time",
  change_log_post: "Change Log",
