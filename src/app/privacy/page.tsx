        ...
        <div className="space-y-8 text-sm text-muted-foreground leading-relaxed [&_h2]:text-foreground [&_h2]:font-semibold [&_h2]:text-base [&_h2]:mb-3 [&_h2]:mt-0 [&_strong]:text-foreground">
          <section>
            ...
            <p>
              ...
              describes how we collect, use, and protect information when you use pacepdm.com and
              app.pacepdm.com (the &quot;Service&quot;).
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              address, and password. If your organization uses SSO, we receive identity attributes
              from your identity provider.
            </p>
            <p>
              <strong>Content you upload.</strong> Files, parts, BOMs, ECOs, and other product data
              you store in the Service. You retain ownership of this content.
            </p>
            <p>
            ...
            <p>
              <strong>Cookies.</strong> We use essential cookies to manage authentication sessions.
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>
                Send transactional emails (notifications, approval reminders, password resets)
              </li>
            ...
            <p>
              We do not sell your personal information. We do not use your uploaded content for any
          ...
          <section>
            ...
            <p>
              We rely on third-party infrastructure providers to operate PACE PDM, including but not
              limited to:
            </p>
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <strong>Supabase</strong> for database, authentication, and file storage
              </li>
              <li>
            ...
            <p>
              ...
              security practices. Your data may be stored and processed in data centers located in
              the United States or other jurisdictions where these providers operate. By using the
          ...
          <section>
            ...
            <p>
              We retain your account information and uploaded content for as long as your account is
              active. If you request account deletion, we will make reasonable efforts to remove
              your personal data in a timely manner. However, some data may persist in backups or
              logs for a limited period and will be deleted in accordance with our standard backup
              rotation schedules.
            </p>
            <p>
              We do not guarantee complete or immediate deletion of all data across all systems and
              backups. Anonymized or aggregated data that cannot be used to identify you may be
          ...
          <section>
            <h2>Data security</h2>
            <p>
              We use commercially reasonable measures to protect your data, including encryption in
              transit (TLS) and encryption at rest via our infrastructure providers. However, no
              method of electronic storage or transmission is 100% secure. We cannot and do not
          ...
          <section>
            ...
            <p>
              ...
              inadvertently collected such information, please contact us and we will take steps to
              delete it.
            </p>
          </section>
