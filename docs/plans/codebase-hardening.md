...
| Routes on `withTenant`                | 0                | **60 / 117**                          | 117                                                   |
...
Worst offenders: `vault/file-detail-panel.tsx` (10), `parts/components/part-form-dialog.tsx` (6), then `vault/upload-file-dialog.tsx` and `vault/cad-viewer.tsx` (2 each). Everything below that is a one- or two-line tail spread across sixteen files.
